...
module.exports = {
    ...
    SESSION_ID: process.env.SESSION_ID || "MEGALODON~MD~6BE0mbiD#LiG_p3Unr1S8CHYuMhc-0bUc-q0SdBx44-HXOipfrqE",
    ...
    OWNER_NUMBER: process.env.OWNER_NUMBER || "50941269979",  // Owner's WhatsApp number
    
    OWNER_NAME: process.env.OWNER_NAME || getConfig("𝗟𝗲𝗻𝘁𝘇 𝖑𝖊 𝕾𝖎𝖌𝖒𝖆") || "",           // Owner's name
    ...
    STICKER_NAME: process.env.STICKER_NAME || "𝗟𝗲𝗻𝘁𝘇 𝖑𝖊 𝕾𝖎𝖌𝖒𝖆",     // Sticker pack name
